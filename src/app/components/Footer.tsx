          ...
          <div className='grid grid-cols-12 gap-y-10 md:gap-x-10 xl:gap-x-20'>
            <div className='col-span-full flex flex-col justify-between space-y-10 md:col-span-3 md:space-y-0'>
              <div className='space-y-[10px]'>
                <div className='h6 text-blue font-extrabold capitalize'>
                  Site Map
                </div>
                <div className='title-2 font-bold text-[#858585]'>
                  Term & Conditions
                </div>
              </div>

              <div className='space-y-[10px]'>
                <div className='h6 text-blue font-extrabold uppercase'>
                  newsletter
                </div>
                <div>
                  <input
                    ...
                    className='title-2 text-blue h-[48px] rounded-xl border-none bg-black px-[14px] py-[10px] placeholder:text-[#858585] focus:outline-none focus:ring-0 xl:h-[70px]'
                  />
                </div>
              </div>
            </div>
            <div className='border-blue col-span-full hidden  space-y-[60px] md:col-span-6 md:block  md:border-l md:border-r'>
            ...
            <div className='col-span-full flex flex-col justify-between md:col-span-3'>
              <div className='space-y-[20px]'>
                <div className='h6 text-blue font-extrabold'>Contact</div>
                <div className='flex items-center space-x-[19px]'>
                  <div className='lg:hover:border-blue lg:hover:bg-blue flex h-12 w-12 items-center justify-center rounded border-2 border-white duration-300 ease-in-out max-lg:h-8 max-lg:w-8'>
                    <Discord />
                  </div>
                  <div className='lg:hover:border-blue lg:hover:bg-blue flex h-12 w-12  items-center justify-center rounded border-2 border-white duration-300 ease-in-out max-lg:h-8 max-lg:w-8'>
                    <Telegram />
              ...
              <div className='title-2 space-y-[20px] text-[#737373] max-md:mt-5 xl:space-y-[30px]'>
                <div>Report</div>
